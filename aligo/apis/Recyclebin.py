...
class Recyclebin(Core):
    ...
    def batch_move_to_trash(self, file_id_list: List[str], drive_id: str = None) -> List[BatchResponse]:
        """..."""
    ...
    def batch_restore_files(self, file_id_list: List[str], drive_id: str = None) -> List[BatchResponse]:
        """..."""
